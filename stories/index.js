...
storiesOf("Appointment", module)
  ...
  .add("Show", () => <Show student="Lydia Miller Jones"
    interviewer={interviewer} onEdit={action("onEdit")} onDelete={action("onDelete")}></Show>)
  .add("Confirm", () => <Confirm message="Delete the appointment?"
    onConfirm={action("onConfirm")}
    onCancel={action("onCancel")}></Confirm>)
  .add("Confirm", () => <Status message="Deleting" />)
  .add("Error", () => <Error message="Could not delete appointment."
    onClose={action("onClose")} />)
  .add("Edit", () => <Form student="Leon Zhou" interviewer={1}
    interviewers={interviewers}
